...
- Choose Rect, Ellipse, Triangle, Diamond, Pentagon, Hexagon, Star, Sector, or Line for shape objects. Sector objects expose start angle, end angle, and inner radius controls.
