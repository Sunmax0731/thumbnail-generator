...
- CSV import, HTML import, Adjust numeric editing, color-wheel point selection without base change, linked point drag that updates the companion colors, RGB slider HEX sync, registered swatch Fill/Stroke apply buttons, removal of target/group UI, saved multi-color palette creation, WebP export, and mobile no-overflow checks: pass.
