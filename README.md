...
- Register, edit, group, preview, delete, and apply named Fill or Stroke colors in the browser-local palette, including opacity, drag-capable Adobe-style color wheel and palette bars, HEX/RGB synchronized input, recent colors, explicit Fill/Stroke color groups, saved multi-color palette sets, grouped harmony suggestions, and palette-level Fill/Stroke application buttons.
