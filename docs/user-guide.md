...
Shape objects support Rect, Ellipse, Triangle, Diamond, Pentagon, Hexagon, Star, Sector, and Line. Corner radius rounds Rect and polygon shape corners; Sector uses Start angle, End angle, and Inner radius controls; Line remains controlled by stroke width and line style.
