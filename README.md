...
- Load 26 bundled default templates, with five starts each for YouTube, Shorts, stream, and cutout use cases plus six schedule starts for yearly, monthly, and daily layouts.
