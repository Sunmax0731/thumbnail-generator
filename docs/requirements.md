...
- Provide Templates-tab generators for editable schedule layouts, standard thumbnails, horizontal thumbnails, and stream waiting screens.
...
- Provide image generators for standard thumbnails, horizontal thumbnails, and stream waiting screens with editable text, shared font choices, title/subtitle/label font-size controls, color, image-slot, grouping, live preview, Generate layers, and Save settings controls. Stream waiting screens include optional animation metadata.
