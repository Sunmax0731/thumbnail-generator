...
- Explore colors with an Adobe-style drag-capable linked color wheel, generated palette bars, `@uiw/react-color` Sketch-style HEX/RGB/alpha input, and recent-color swatches.
