...
- Generate standard thumbnails, horizontal thumbnails, and stream waiting screens from Templates. Each image generator has content, Grid / text typography, color, preview, Generate layers, and Save settings controls.
