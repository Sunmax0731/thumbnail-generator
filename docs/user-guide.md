...
- Templates: generate schedule layouts, standard thumbnails, horizontal thumbnails, or stream waiting screens, and save/load/delete browser-local templates.
