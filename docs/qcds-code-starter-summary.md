...
Completed on 2026-06-07. Refreshed on 2026-06-12 after popup color picker, template resizing, Image Lab, single-color picker, OBS preview, Colors, Adjust, Shape, output-menu, top-right edit-state, timeline, Motion follow-up work, PWA support, Chrome extension bridge structure, `アニメ` tab label, and `サムネいる？` title work.
