...
- Provide a beta schedule generator in Templates that creates monthly or weekly editable schedule layer sets from date inputs, Sunday/Monday week-start settings, canvas orientation, grid style, font, color, corner radius, and line-width controls.
