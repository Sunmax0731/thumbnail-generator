...
- [x] [P2] [Phase:04-implementation] カラーパレット操作と色グループ削除の改善 [Issue](Issues/0051-issue.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:03-design] 縁ぼかし表示が反映されない [Issue](Issues/0052-issue.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:05-test] 調整機能ボタン幅とGUIレイアウト改善 [Issue](Issues/0053-gui.md) [QCDS:Quality,Satisfaction] [Status:closed]
...
- [x] [P2] [Phase:03-design] Layers/Assetsのクイック追加UI再配置と折りたたみ対応 [Issue](Issues/0074-layers-assets-ui.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:03-design] 左ペインのレイアウトタブをGUI非表示にする [Issue](Issues/0075-gui.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:03-design] 左ペインの制作導線UI削除 [Issue](Issues/0076-ui.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:03-design] ブランドキットUIをテンプレタブから非表示化 [Issue](Issues/0077-ui.md) [QCDS:Quality,Satisfaction] [Status:closed]
...
- [x] [P2] [Phase:04-implementation] ImageLab初期選択/削除後選択/GA/Motion/UI整理 [Issue](Issues/0084-ui-motion-analytics-followup.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:04-implementation] 日の予定テンプレート生成と扇形図形対応 [Issue](Issues/0085-daily-schedule-generator.md) [QCDS:Quality,Satisfaction] [Status:closed]
- [x] [P2] [Phase:04-implementation] 日の予定時刻入力と扇形同期 [Issue](Issues/0086-daily-schedule-time-sync.md) [QCDS:Quality,Satisfaction] [Status:closed]
