...
- 上部ツールバー: 表示言語、プリセット、幅、高さ、品質、PNG/JPG/WebP の直接出力を操作します。
...
テンプレートを読み込んだあと、上部ツールバーで出力プリセット、幅、高さ、品質を確認します。YouTube 16:9 なら `1280x720`、Shorts 向けなら縦長プリセットを使います。形式は PNG/JPG/WebP の直接出力ボタンで選びます。
...
1. 必要に応じて品質スライダーを調整します。
2. 上部ツールバーの PNG、JPG、WebP ボタンから出力したい形式を直接選びます。
3. ブラウザのダウンロードとしてサムネイル画像が保存されます。
