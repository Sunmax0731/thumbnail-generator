...
- Use the Templates tab generator buttons to create editable monthly, weekly, or daily schedule layouts, standard thumbnails, vertical thumbnails, and stream waiting screens. Daily schedules can include AM/PM sector circles, compact start/end time inputs, independent AM/PM event visibility, AM `0`-`11` and PM `12`-`24` clock-hour labels, and adjustable circle size.
