      ...
      sections: [
        ...
        section("shape-image", tx("図形・画像", "Shape and image"), tx(`${label("inspector.shapeControls")} / ${label("inspector.imageControls")}`, `${label("inspector.shapeControls")} / ${label("inspector.imageControls")}`), tx("図形と画像に固有の設定を編集します。", "Edits settings specific to shapes and images."), [
          entry("shape", tx("塗り・線・角丸・線種", "Fill, stroke, radius, and line style"), tx("図形の面、輪郭、角、線の表現を設定します。", "Controls shape fill, outline, corners, and line rendering."), [
            tx(`図形ドロップダウン: ${label("inspector.rect")} は四角、${label("inspector.ellipse")} は楕円、${label("inspector.triangle")} / ${label("inspector.diamond")} / ${label("inspector.pentagon")} / ${label("inspector.hexagon")} / ${label("inspector.star")} は多角形や星形、${label("inspector.sector")} は角度で調整する扇形です。`, "Shape dropdown: rectangle is a box, ellipse is an oval, triangle/diamond/pentagon/hexagon/star are polygon shapes, and sector is a wedge controlled by angles."),
